...
SECRET_KEY = 'ujy^$m1c%xrjkt(24@f_op2itak8%*@tcki@2dm!+*%aphp8se'
...
MIDDLEWARE = [
    ...
    'api.middlewares.AdminSecureMiddleware',
    'api.middlewares.StatisticsMiddleware',
]
...
REST_FRAMEWORK = {
    'DEFAULT_THROTTLE_CLASSES': [
        'api.throttle.TokenBucketRateThrottle'
    ],
}
